...
export const posts: Post[] = [
  { slug: "controlled-substance-inventory-and-recordkeeping", cluster: "controlled", title: "Controlled Substance Inventory & Recordkeeping: A DEA Guide", excerpt: "Initial and biennial inventories, perpetual logs, Form 222 records, the 2-year rule, and how documented disposal closes the loop." },
  ...
  { slug: "reverse-distribution-for-controlled-substances", cluster: "reverse", title: "Reverse Distribution for Controlled Substances: A DEA Guide", excerpt: "How DEA registrants use a DEA-registered reverse distributor — Form 222/41, ARCOS, credit vs. destruction, and how to stay audit-ready." },
  { slug: "pharmacy-drug-return-process-recover-credit-on-expired-drugs", cluster: "reverse", title: "The Pharmacy Drug Return Process: Recover Credit on Expired Drugs", excerpt: "What's returnable for manufacturer credit, the step-by-step return process, how credit works, and how to maximize your returns." },
  ...
  { slug: "how-to-choose-a-medical-waste-disposal-company", cluster: "biohazard", title: "How to Choose a Medical Waste Disposal Company", excerpt: "The criteria that matter, the red flags to avoid, and the exact questions to ask before you sign with a disposal vendor." },
  { slug: "hipaa-compliant-medical-waste-disposal", cluster: "biohazard", title: "HIPAA-Compliant Medical Waste Disposal", excerpt: "How HIPAA applies to PHI on labels and packaging, when you need a BAA, and how to dispose of PHI-bearing waste compliantly." },
  { slug: "medical-waste-violations-and-fines", cluster: "biohazard", title: "Medical Waste Violations & Fines: The Ones That Cost You", excerpt: "The most common violations by agency (OSHA/DEA/EPA/DOT/HIPAA), what they cost, and how to stay clear." },
  { slug: "osha-medical-waste-requirements", cluster: "biohazard", title: "OSHA Medical Waste Requirements: Bloodborne Pathogens & Compliance", excerpt: "The Bloodborne Pathogens Standard, exposure control plans, sharps containers, annual training, and the common violations." },
  { slug: "biohazard-waste-management", cluster: "biohazard", title: "Biohazard Waste Management: A Complete Guide for Facilities", excerpt: "The full program — segregate, contain, store, transport, treat, document — and the OSHA/DOT/state rules behind each step." },
  { slug: "medical-waste-color-codes", cluster: "biohazard", title: "Medical Waste Color Codes: Red, Yellow, Black & Blue Explained", excerpt: "What each container color means, what goes in each, and why segregating right keeps you compliant and controls cost." },
  { slug: "biohazard-waste-disposal-cost", cluster: "biohazard", title: "How Much Does Biohazard Waste Disposal Cost?", excerpt: "Real biohazard mail-back prices ($75-$405), what drives cost, mail-back vs. hauler, and how to pay less." },
  { slug: "medical-waste-disposal-guide", cluster: "biohazard", title: "Medical Waste Disposal: Types, Methods & How It Works", excerpt: "A complete guide — the six regulated streams, how each is disposed of, the treatment methods, the rules, cost, and choosing a provider." },
  { slug: "what-is-biohazard-waste", cluster: "biohazard", title: "What Is Biohazard Waste? Types, Examples & Disposal", excerpt: "The definition, the six types, real examples, the red-bag color-coding rules, and how to dispose of biohazardous waste compliantly." },
  ...
  { slug: "medication-take-back-programs-for-pharmacies", cluster: "medkit", title: "Medication Take-Back Programs for Pharmacies & Facilities", excerpt: "Mail-back kits vs. kiosks, the DEA rules, why it builds patient trust, and how to set one up." },
  ...
  { slug: "usp-800-guide", cluster: "chemo", title: "USP 800: The Complete Guide to Hazardous Drug Handling", excerpt: "Who USP <800> applies to, the facility/PPE/storage/disposal requirements, and how it connects to your chemo and RCRA waste program." },
  { slug: "chemotherapy-waste-disposal-guide", cluster: "chemo", title: "Chemotherapy Waste Disposal: The Complete Guide", excerpt: "Trace vs. bulk, the yellow-container rule, USP 800 handling, treatment, and how bulk/P-listed chemo is managed as RCRA-hazardous." },
  ...
  { slug: "is-warfarin-hazardous-waste", cluster: "rcra", title: "Is Warfarin Hazardous Waste? P-Listed vs. U-Listed Disposal", excerpt: "Warfarin is P001 above 0.3% and U248 at or below — how to classify and dispose of it under RCRA." },
  { slug: "rcra-hazardous-waste-container-requirements", cluster: "rcra", title: "RCRA Hazardous Waste Container Requirements (Black Containers)", excerpt: "The black container, labeling, closed-and-compatible rules, accumulation limits, and dating under Subpart P." },
  { slug: "hazardous-drug-disposal-for-pharmacies", cluster: "rcra", title: "How Pharmacies Dispose of Hazardous Waste (RCRA Guide)", excerpt: "The hazardous drugs on your shelf, generator status, Subpart P obligations, and the setup that passes inspection." },
  { slug: "hazardous-pharmaceutical-waste-disposal-guide", cluster: "rcra", title: "Hazardous Pharmaceutical Waste Disposal: RCRA, P & U Lists", excerpt: "What makes a drug RCRA-hazardous, P/U/D-listed drugs, the Subpart P standard, black-container rules, and how to dispose of it." },
  ...
  { slug: "expired-drug-disposal-for-pharmacies-and-facilities", cluster: "pharma", title: "Expired Drug Disposal for Pharmacies & Facilities", excerpt: "The sort that recovers credit, routes controlled and hazardous drugs correctly, and keeps you compliant and documented." },
  ...
  { slug: "reverse-distribution-vs-destruction", cluster: "reverse", title: "Reverse Distribution vs. Destruction: Which Path for Your Expired Drugs?", excerpt: "When you have expired, unused, or unwanted pharmaceuticals, you have two very different disposal paths: send returnable stock to a reverse distributor" },
  { slug: "mail-back-kit-vs-deactivation-pouch-vs-drop-box", cluster: "medkit", title: "Mail-Back Kit vs. Deactivation Pouch vs. Drop Box: A Clear Comparison", excerpt: "There are three common ways to dispose of unused and expired medication: DEA-authorized mail-back envelopes and kits, in-home drug deactivation pouche" },
  { slug: "how-to-dispose-of-sharps-at-home", cluster: "sharps", title: "How to Dispose of Sharps at Home Safely", excerpt: "If you inject medication at home, you generate sharps that can't go in the household trash or recycling. Here is how to handle used needles safely, st" },
  { slug: "sharps-disposal-cost", cluster: "sharps", title: "Sharps Disposal Cost: What Actually Drives the Price", excerpt: "Sharps disposal pricing is rarely apples-to-apples. Here is how the two service models work, what really drives the number, how to compare quotes fair" },
  { slug: "rcra-p-list-u-list-pharmaceuticals", cluster: "rcra", title: "RCRA P-List and U-List Pharmaceuticals, Explained", excerpt: "The EPA lists specific chemicals that make a discarded drug federally hazardous waste. Here are the well-established P-listed, U-listed, and character" },
  { slug: "epa-subpart-p-explained", cluster: "rcra", title: "EPA Subpart P Explained", excerpt: "Subpart P is the EPA rule that governs how healthcare handles hazardous waste pharmaceuticals. Here is what it requires, who it applies to, and the pr" },
];
