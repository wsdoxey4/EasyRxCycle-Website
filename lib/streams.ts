...
const sharps: Stream = {
  ...
  kitLabel: "Shop a kit",
  metaTitle: (s) => `Sharps Disposal in ${s.name} | Mail-Back Kits`,
  metaDesc: (s) => `OSHA- & DOT-compliant sharps disposal in ${s.name}. Prepaid mail-back kits and pickup for ${s.cities[0]} and statewide, documented on every order.`,
...
const biohazard: Stream = {
  ...
  kitLabel: "Shop a kit",
  metaTitle: (s) => `Biohazard Waste Disposal in ${s.name}`,
  metaDesc: (s) => `OSHA- & DOT-compliant biohazard & RMW disposal in ${s.name}. Mail-back kits and pickup for ${s.cities[0]} and statewide, documented on every order.`,
...
const pharmaceutical: Stream = {
  ...
  kitLabel: "Shop a kit",
  metaTitle: (s) => `Pharmaceutical Waste Disposal in ${s.name}`,
  metaDesc: (s) => `Compliant pharmaceutical & expired-drug disposal in ${s.name}. Mail-back and pickup for ${s.cities[0]} and statewide; controlled & RCRA routed correctly.`,
...
const traceChemo: Stream = {
  ...
  kitLabel: "Shop a kit",
  metaTitle: (s) => `Trace Chemo Waste Disposal in ${s.name}`,
  metaDesc: (s) => `Compliant trace chemotherapy waste disposal in ${s.name}. Yellow-container mail-back for ${s.cities[0]} and statewide, incinerated and documented.`,
...
const rcra: Stream = {
  ...
  kitLabel: "Shop a kit",
  metaTitle: (s) => `RCRA Hazardous Waste Disposal in ${s.name}`,
  metaDesc: (s) => `EPA RCRA-compliant hazardous drug waste disposal in ${s.name}. P/U/D-listed mail-back for ${s.cities[0]} and statewide, managed under Subpart P with a manifest.`,
...
const medication: Stream = {
  ...
  kitLabel: "Shop a kit",
  metaTitle: (s) => `Medication Disposal Kits in ${s.name} | Mail-Back`,
  metaDesc: (s) => `DEA-compliant medication mail-back kits in ${s.name}. Patient take-back of unused Rx incl. controlled, for ${s.cities[0]} and statewide, with destruction docs.`,
...
const reverse: Stream = {
  ...
  metaTitle: (s) => `Reverse Distribution in ${s.name}`,
  metaDesc: (s) => `DEA-registered reverse distribution in ${s.name}. Recover manufacturer credit on returnable Rx and destroy the rest, for ${s.cities[0]} and statewide.`,
