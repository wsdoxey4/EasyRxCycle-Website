...
export default function Footer() {
  ...
  <div className="fgrid">
    ...
    <div><h5>Solutions</h5><ul><li><a href="/#solutions">Sharps disposal</a></li><li><a href="/#solutions">Biohazard / RMW</a></li><li><a href="/#solutions">Pharmaceutical waste</a></li><li><a href="/our-solutions/controlled-substance-destruction">Controlled substances</a></li><li><a href="/#solutions">Reverse distribution</a></li><li><a href="/build-your-program">Build a program</a></li><li><a href="/pricing">Pricing</a></li><li><a href="/cost-calculator">Cost calculator</a></li></ul></div>
    ...
    <div><h5>Get in touch</h5><ul><li><a href="tel:5019042929">501-904-2929</a></li><li><a href="mailto:sales@easyrxcycle.com">sales@easyrxcycle.com</a></li><li><a href="/contact">Contact us</a></li><li><a href="/how-it-works">How it works</a></li><li><a href="/faq">FAQ</a></li></ul></div>
  </div>
  <div className="fbar">
