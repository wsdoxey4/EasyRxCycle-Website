...
export default function Footer() {
  ...
  <div className="fgrid">
    ...
    <div><h5>Resources</h5><ul><li><a href="/resources">Resources hub</a></li><li><a href="/resources/guides">Guide library</a></li><li><a href="/blog/">Blog</a></li><li><a href="/compare">Compare us</a></li><li><a href="/medical-waste-regulations-by-state">State regulations</a></li><li><a href="/faq">FAQ</a></li><li><a href="/cost-calculator">Cost calculator</a></li></ul></div>
