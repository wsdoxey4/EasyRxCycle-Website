...
const PATH = "/our-solutions/rcra-hazardous-pharmaceutical-waste/new-mexico";
const TITLE = "RCRA Hazardous Waste Disposal in New Mexico | Mail-Back & Pickup";
const DESC = "RCRA Hazardous Waste Disposal in New Mexico \u2014 DEA-registered mail-back kits and scheduled pickup for Albuquerque and statewide, with a Certificate of Destruction. EPA-compliant disposal of P-, U-, and D-listed hazardous pharmaceutical waste.";
...
const faqs = [
  { q: "How do I dispose of RCRA-hazardous drug waste in New Mexico?", a: "We identify P-, U-, and D-listed drugs, segregate them into compliant containers, and ship them on a hazardous-waste manifest to a permitted facility for incineration \u2014 with a Certificate of Destruction. We serve Albuquerque and statewide." },
  { q: "Is nicotine or warfarin hazardous waste in New Mexico?", a: "Yes \u2014 nicotine (P075) and warfarin are federally P-listed hazardous waste everywhere, including New Mexico, and can't go in the trash or be sewered." },
  { q: "Do you provide hazardous-waste manifests in New Mexico?", a: "Yes \u2014 RCRA-hazardous drug waste ships on a manifest to a permitted facility across New Mexico, with signed copies returned alongside your Certificate of Destruction." },
  { q: "Who regulates hazardous pharmaceutical waste in New Mexico?", a: "The EPA under RCRA Subpart P, plus the New Mexico Environment Department (NMED) at the state level. We handle disposal to both." }
];

const jsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    { "@type": "Service", "@id": `${abs(PATH)}#service`, name: "RCRA Hazardous Waste Disposal in New Mexico", serviceType: "RCRA Hazardous Waste Disposal", description: DESC, provider: { "@id": `${SITE.url}/#organization` }, areaServed: { "@type": "State", name: "New Mexico" }, url: abs(PATH) },
    ...
    <>
      ...
      <main id="main">
        <section className="subhero">
          <div className="wrap">
            <Breadcrumbs items={[{ name: "Solutions", href: "/#solutions" }, { name: "RCRA Hazardous Waste Disposal", href: "/our-solutions/rcra-hazardous-pharmaceutical-waste/" }, { name: "New Mexico" }]} />
            <span className="eyebrow">RCRA Hazardous Waste Disposal · New Mexico</span>
            <h1 className="ph1">RCRA Hazardous Waste Disposal in <span style={{ color: "var(--teal)" }}>New Mexico.</span></h1>
            <p className="lead" style={{ marginTop: "18px", maxWidth: "62ch" }} dangerouslySetInnerHTML={{ __html: "Need RCRA hazardous pharmaceutical waste disposal in New Mexico? Easy Rx Cycle serves Albuquerque, Las Cruces, Santa Fe, Rio Rancho and communities across New Mexico with EPA-compliant disposal of P-, U-, and D-listed hazardous pharmaceutical waste \u2014 p-listed (warfarin, nicotine, epinephrine), u-listed pharmaceuticals, ignitable / corrosive / toxic (d-codes), with a Certificate of Destruction on every order and no contract." }} />
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What we take</span><h2>RCRA Hazardous Waste Disposal for New Mexico, every stream.</h2></div>
            <ul className="covers">
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            ...
            <p className="lead" style={{ marginTop: "16px" }} dangerouslySetInnerHTML={{ __html: "RCRA-hazardous pharmaceutical waste in New Mexico is regulated by the EPA under Subpart P, plus the New Mexico Environment Department (NMED). We identify P-, U-, and D-listed drugs, manifest them, and destroy them at a permitted facility \u2014 with a Certificate of Destruction and cradle-to-grave records." }} />
          </div>
        </section>
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">FAQ</span><h2>RCRA Hazardous Waste Disposal in New Mexico: questions.</h2></div>
        ...
        <section className="sec" style={{ paddingTop: "0" }}>
          <div className="wrap">
            <div className="finalcta">
              <div>
                <h2>Get a rcra hazardous waste disposal quote for New Mexico.</h2>
