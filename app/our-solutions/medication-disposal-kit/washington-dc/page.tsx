...
const PATH = "/our-solutions/medication-disposal-kit/washington-dc";
const TITLE = "Medication Disposal in Washington, D.C. | Mail-Back & Pickup";
const DESC = "Medication Disposal in Washington, D.C. \u2014 DEA-registered mail-back kits and scheduled pickup for Washington and statewide, with a Certificate of Destruction. DEA-compliant mail-back medication disposal kits for controlled and non-controlled drugs.";
...
const faqs = [
  { q: "How do I dispose of medications in Washington, D.C.?", a: "Order a prepaid, tamper-evident mail-back kit, fill it, seal it, and drop it in any mailbox \u2014 controlled and non-controlled medications alike are destroyed non-retrievable with a Certificate of Destruction. We serve Washington and statewide." },
  { q: "Can I mail back controlled substances in Washington, D.C.?", a: "Yes \u2014 our kits are DEA-compliant for mail-back of controlled substances (Schedules II\u2013V) as well as non-controlled and OTC medications, across Washington, D.C.." },
  { q: "Do you offer medication take-back for facilities in Washington, D.C.?", a: "Yes \u2014 pharmacies, LTC, and hospice in Washington, D.C. use our kits with DEA Form 41 documentation; consumers can use at-home take-back kits too." },
  { q: "Who regulates medication disposal in Washington, D.C.?", a: "The DEA (controlled substances) and the EPA/the DC Department of Energy & Environment (DOEE) (other drugs). Our kits are compliant with both." }
];

const jsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    { "@type": "Service", "@id": `${abs(PATH)}#service`, name: "Medication Disposal in Washington, D.C.", serviceType: "Medication Disposal", description: DESC, provider: { "@id": `${SITE.url}/#organization` }, areaServed: { "@type": "State", name: "Washington, D.C." }, url: abs(PATH) },
    ...
    <>
      ...
      <main id="main">
        <section className="subhero">
          <div className="wrap">
            <Breadcrumbs items={[{ name: "Solutions", href: "/#solutions" }, { name: "Medication Disposal", href: "/our-solutions/medication-disposal-kit/" }, { name: "Washington, D.C." }]} />
            <span className="eyebrow">Medication Disposal · Washington, D.C.</span>
            <h1 className="ph1">Medication Disposal in <span style={{ color: "var(--teal)" }}>Washington, D.C..</span></h1>
            <p className="lead" style={{ marginTop: "18px", maxWidth: "62ch" }} dangerouslySetInnerHTML={{ __html: "Need medication disposal in Washington, D.C.? Easy Rx Cycle serves Washington and communities across Washington, D.C. with DEA-compliant mail-back medication disposal kits for controlled and non-controlled drugs \u2014 controlled substances (schedules ii\u2013v), non-controlled prescription meds, over-the-counter medications, with a Certificate of Destruction on every order and no contract." }} />
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What we take</span><h2>Medication Disposal for Washington, D.C., every stream.</h2></div>
            <ul className="covers">
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            ...
            <p className="lead" style={{ marginTop: "16px" }} dangerouslySetInnerHTML={{ __html: "Medication disposal in Washington, D.C. follows DEA rules for controlled drugs and EPA/state rules for the rest, plus the DC Department of Energy & Environment (DOEE). Our DEA-compliant mail-back kits handle controlled and non-controlled medications, rendered non-retrievable \u2014 with a Certificate of Destruction on every kit." }} />
          </div>
        </section>
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">FAQ</span><h2>Medication Disposal in Washington, D.C.: questions.</h2></div>
        ...
        <section className="sec" style={{ paddingTop: "0" }}>
          <div className="wrap">
            <div className="finalcta">
              <div>
                <h2>Get a medication disposal quote for Washington, D.C..</h2>
