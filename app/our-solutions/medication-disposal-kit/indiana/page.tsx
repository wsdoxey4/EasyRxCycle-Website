...
const PATH = "/our-solutions/medication-disposal-kit/indiana";
const TITLE = "Medication Disposal in Indiana | Mail-Back & Pickup";
const DESC = "Medication Disposal in Indiana \u2014 DEA-registered mail-back kits and scheduled pickup for Indianapolis and statewide, with a Certificate of Destruction. DEA-compliant mail-back medication disposal kits for controlled and non-controlled drugs.";
...
const faqs = [
  { q: "How do I dispose of medications in Indiana?", a: "Order a prepaid, tamper-evident mail-back kit, fill it, seal it, and drop it in any mailbox \u2014 controlled and non-controlled medications alike are destroyed non-retrievable with a Certificate of Destruction. We serve Indianapolis and statewide." },
  { q: "Can I mail back controlled substances in Indiana?", a: "Yes \u2014 our kits are DEA-compliant for mail-back of controlled substances (Schedules II\u2013V) as well as non-controlled and OTC medications, across Indiana." },
  { q: "Do you offer medication take-back for facilities in Indiana?", a: "Yes \u2014 pharmacies, LTC, and hospice in Indiana use our kits with DEA Form 41 documentation; consumers can use at-home take-back kits too." },
  { q: "Who regulates medication disposal in Indiana?", a: "The DEA (controlled substances) and the EPA/the Indiana Department of Environmental Management (IDEM) (other drugs). Our kits are compliant with both." }
];

const jsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    { "@type": "Service", "@id": `${abs(PATH)}#service`, name: "Medication Disposal in Indiana", serviceType: "Medication Disposal", description: DESC, provider: { "@id": `${SITE.url}/#organization` }, areaServed: { "@type": "State", name: "Indiana" }, url: abs(PATH) },
    ...
    <>
      ...
      <main id="main">
        <section className="subhero">
          <div className="wrap">
            <Breadcrumbs items={[{ name: "Solutions", href: "/#solutions" }, { name: "Medication Disposal", href: "/our-solutions/medication-disposal-kit/" }, { name: "Indiana" }]} />
            <span className="eyebrow">Medication Disposal · Indiana</span>
            <h1 className="ph1">Medication Disposal in <span style={{ color: "var(--teal)" }}>Indiana.</span></h1>
            <p className="lead" style={{ marginTop: "18px", maxWidth: "62ch" }} dangerouslySetInnerHTML={{ __html: "Need medication disposal in Indiana? Easy Rx Cycle serves Indianapolis, Fort Wayne, Evansville, South Bend and communities across Indiana with DEA-compliant mail-back medication disposal kits for controlled and non-controlled drugs \u2014 controlled substances (schedules ii\u2013v), non-controlled prescription meds, over-the-counter medications, with a Certificate of Destruction on every order and no contract." }} />
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What we take</span><h2>Medication Disposal for Indiana, every stream.</h2></div>
            <ul className="covers">
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            ...
            <p className="lead" style={{ marginTop: "16px" }} dangerouslySetInnerHTML={{ __html: "Medication disposal in Indiana follows DEA rules for controlled drugs and EPA/state rules for the rest, plus the Indiana Department of Environmental Management (IDEM). Our DEA-compliant mail-back kits handle controlled and non-controlled medications, rendered non-retrievable \u2014 with a Certificate of Destruction on every kit." }} />
          </div>
        </section>
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">FAQ</span><h2>Medication Disposal in Indiana: questions.</h2></div>
        ...
        <section className="sec" style={{ paddingTop: "0" }}>
          <div className="wrap">
            <div className="finalcta">
              <div>
                <h2>Get a medication disposal quote for Indiana.</h2>
