...
const PATH = "/who-we-serve/specialty-pharmacy";
const TITLE = "Specialty Pharmacy Controlled Substance & Rx Disposal | Reverse Distribution";
const DESC = "Compliant controlled substance, pharmaceutical, and returnable-Rx disposal for specialty pharmacies \u2014 DEA-compliant destruction, reverse distribution for credit recovery, and a Certificate of Destruction on every order.";
...
const faqs = [
  { q: "How do specialty pharmacies dispose of high-cost expired drugs?", a: "Through reverse distribution \u2014 returnable specialty and biologic stock is processed for manufacturer credit, and non-returnable product is compliantly destroyed with documentation." },
  { q: "Do you handle hazardous or oncology specialty drugs?", a: "Yes \u2014 hazardous specialty drugs route to RCRA-compliant destruction, and trace chemo materials are incinerated per USP 800 handling." },
  { q: "Can you handle controlled specialty medications?", a: "Yes, with DEA Form 222/41 and non-retrievable destruction." },
  { q: "Is credit recovery worth it for specialty inventory?", a: "Often significantly \u2014 specialty drugs are high-cost, so maximizing returnable credit has real financial impact." },
  { q: "Is the documentation audit-ready?", a: "Yes \u2014 full chain-of-custody, DEA forms, and Certificates of Destruction, archived for audits." },
  { q: "Can we recover credit on expensive biologics?", a: "Yes — returnable high-cost specialty product often carries meaningful manufacturer credit through reverse distribution. It's worth far more than writing it off." },
  { q: "How do we handle hazardous specialty and oncology drugs?", a: "Identify RCRA-hazardous agents (P/U-listed and characteristic), segregate them, and destroy to EPA standards. We'll help you flag which of your products qualify." },
  { q: "What about controlled specialty drugs?", a: "Destroyed non-retrievable with Form 222/41 through our DEA-registered reverse distribution." },
...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Service", "@id": `${abs(PATH)}#service`, name: "Specialty Pharmacy Rx Disposal & Reverse Distribution", serviceType: "Medical & pharmaceutical waste disposal", description: DESC, provider: { "@id": `${SITE.url}/#organization` }, areaServed: { "@type": "Country", name: "United States" }, audience: { "@type": "Audience", audienceType: "Specialty pharmacies" }, url: abs(PATH) },
    ...
    <>
      ...
      <main id="main">
        <section className="subhero">
          <div className="wrap">
            <Breadcrumbs items={[{ name: "Who We Serve", href: "/who-we-serve/" }, { name: "Specialty pharmacies" }]} />
            <span className="eyebrow">Specialty pharmacies</span>
            <h1 className="ph1" dangerouslySetInnerHTML={{ __html: "Controlled & Rx disposal for <span style=\"color:var(--teal)\">specialty pharmacies.</span>" }} />
            <p className="lead" style={{ marginTop: "18px", maxWidth: "62ch" }} dangerouslySetInnerHTML={{ __html: "Controlled-substance, pharmaceutical, and returnable-Rx disposal built for specialty pharmacies \u2014 DEA-compliant destruction, reverse distribution to recover credit, and a Certificate of Destruction every time, with audit-ready documentation. High-cost specialty and biologic inventory, disposed of and credited correctly." }} />
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What you deal with</span><h2 dangerouslySetInnerHTML={{ __html: "Tight inventory accountability." }} /><p className="lead" dangerouslySetInnerHTML={{ __html: "Specialty pharmacies handle high-cost biologics and specialty drugs \u2014 where correct disposal and credit recovery really matter." }} /></div>
            <ul className="covers">
          ...
          <div className="wrap">
            <div className="guideband">
              <div className="gb-body">
                <span className="eyebrow">Free guide · for specialty pharmacies</span>
                <h3>The Specialty Pharmacy's Guide to Compliant Waste Disposal</h3>
                <p>High-cost biologics, hazardous drugs, controls & cold-chain — recover credit and stay compliant. Includes a checklist, cheat sheet & FAQ.</p>
              </div>
              <div className="gb-cta">
                <a className="btn btn-primary" href="/resources/specialty-pharmacy-waste-disposal-guide">Download the free guide <span className="ar">→</span></a>
          ...
          <div className="wrap">
            ...
            <div className="relcols">
              <div className="relcol"><h3>Related industries</h3><ul>
                ...
                <li><a href="/who-we-serve/340b-pharmacy">340B pharmacies</a></li>
              ...
              <div className="relcol"><h3>Guides &amp; articles</h3><ul>
                <li><a href="/resources/specialty-pharmacy-waste-disposal-guide">Free Specialty pharmacies guide (PDF)</a></li>
                <li><a href="/blog/how-to-use-a-reverse-distributor-for-safe-drug-disposal">Using a reverse distributor</a></li>
        ...
        <section className="sec how" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">FAQ</span><h2>Specialty pharmacies disposal questions.</h2></div>
      ...
      <ExitIntentGuide slug="specialty-pharmacy-waste-disposal-guide" />
