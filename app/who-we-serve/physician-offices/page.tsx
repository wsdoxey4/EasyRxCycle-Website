...
const faqs = [
  ...
  { q: "Do we need controlled-substance disposal if we only sample?", a: "If you stock or sample any Schedule I–V drug, expired or wasted stock must be destroyed non-retrievable with a Form 41." },
