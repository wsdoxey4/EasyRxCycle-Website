...
const PATH = "/who-we-serve/340b-pharmacy";
const TITLE = "340B Pharmacy Controlled Substance & Rx Disposal | Reverse Distribution";
const DESC = "Compliant controlled substance, pharmaceutical, and returnable Rx disposal for 340B pharmacies \u2014 DEA-compliant destruction, reverse distribution for credit recovery, and a Certificate of Destruction on every order.";
...
const faqs = [
  { q: "How does a 340B pharmacy dispose of controlled substances?", a: "Through a DEA-registered reverse distributor: controls are rendered non-retrievable with DEA Form 41 (and Form 222 for Schedule II), and a Certificate of Destruction is issued \u2014 with documentation suited to 340B accountability." },
  { q: "Can 340B pharmacies recover credit on expired Rx?", a: "Yes \u2014 reverse distribution sorts inventory into credit-eligible returns (processed for manufacturer credit) and non-returnable stock (compliantly destroyed), which matters under tight 340B economics." },
  { q: "Do you segregate RCRA-hazardous drugs?", a: "Yes. Hazardous pharmaceuticals are segregated and manifested to a permitted facility, separate from your non-hazardous and controlled streams." },
  { q: "Is the documentation audit-ready?", a: "Yes \u2014 Form 222, Form 41, chain-of-custody, credit records, and Certificates of Destruction are archived and available for DEA, state, and 340B program audits." },
  { q: "Do you serve contract and specialty 340B pharmacies?", a: "Yes \u2014 retail, specialty, and contract 340B pharmacies get the same compliant, documented reverse-distribution and destruction service." },
  { q: "Does reverse distribution help our 340B audit?", a: "Yes — beyond recovering credit, it produces documented return and destruction records that make your program defensible in an audit." },
  { q: "How are controlled substances documented?", a: "With Form 222 for Schedule II transfers, Form 41 for surrendered controls, and a Certificate of Destruction — all audit-ready." },
  { q: "Do you keep records we can pull for audits?", a: "Yes — Certificates of Destruction and return documentation are archived to your account." },
...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Service", "@id": `${abs(PATH)}#service`, name: "340B Pharmacy Rx Disposal & Reverse Distribution", serviceType: "Medical & pharmaceutical waste disposal", description: DESC, provider: { "@id": `${SITE.url}/#organization` }, areaServed: { "@type": "Country", name: "United States" }, audience: { "@type": "Audience", audienceType: "340B pharmacies" }, url: abs(PATH) },
    ...
    <>
      ...
      <main id="main">
        <section className="subhero">
          <div className="wrap">
            <Breadcrumbs items={[{ name: "Who We Serve", href: "/who-we-serve/" }, { name: "340B pharmacies" }]} />
            <span className="eyebrow">340B pharmacies</span>
            <h1 className="ph1" dangerouslySetInnerHTML={{ __html: "Controlled & Rx disposal for <span style=\"color:var(--teal)\">340B pharmacies.</span>" }} />
            <p className="lead" style={{ marginTop: "18px", maxWidth: "62ch" }} dangerouslySetInnerHTML={{ __html: "Controlled-substance, pharmaceutical, and returnable-Rx disposal built for 340B pharmacies \u2014 DEA-compliant destruction, reverse distribution to recover credit, and a Certificate of Destruction every time, with the documentation your program and audits demand." }} />
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What you deal with</span><h2 dangerouslySetInnerHTML={{ __html: "340B means extra scrutiny on every dollar." }} /><p className="lead" dangerouslySetInnerHTML={{ __html: "340B pharmacies manage tight inventory accountability \u2014 disposal has to be documented and credit-maximizing." }} /></div>
            <ul className="covers">
          ...
          <div className="wrap">
            <div className="guideband">
              <div className="gb-body">
                <span className="eyebrow">Free guide · for 340B pharmacies</span>
                <h3>The 340B Pharmacy's Guide to Compliant Waste Disposal</h3>
                <p>Recover credit and keep the audit-ready records 340B demands — controls, hazardous & non-hazardous streams. Includes a checklist, cheat sheet & FAQ.</p>
              </div>
              <div className="gb-cta">
                <a className="btn btn-primary" href="/resources/340b-pharmacy-waste-disposal-guide">Download the free guide <span className="ar">→</span></a>
        ...
        <section className="sec how" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What we handle for you</span><h2>One partner for the 340B waste stream.</h2><p className="lead">Every stream you generate, routed to the right compliant process.</p></div>
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            ...
            <div className="flow">
              <div className="step"><div className="n">1</div><h4>Send us your inventory</h4><p>Scheduled pickup or mail-back for expired and returnable stock, with full documentation.</p></div>
        ...
        <section className="sec how" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">Compliance</span><h2>DEA, EPA &amp; 340B documentation.</h2></div>
          ...
          <div className="wrap">
            ...
            <div className="relcols">
              ...
              <div className="relcol"><h3>Guides &amp; articles</h3><ul>
                <li><a href="/resources/340b-pharmacy-waste-disposal-guide">Free 340B pharmacies guide (PDF)</a></li>
        ...
        <section className="sec how" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">FAQ</span><h2>340B pharmacy disposal questions.</h2></div>
        ...
        <section className="sec" style={{ paddingTop: "0" }}>
          <div className="wrap">
            <div className="finalcta">
              <div>
                <h2>Compliant, credit-maximizing disposal for 340B.</h2>
      ...
      <ExitIntentGuide slug="340b-pharmacy-waste-disposal-guide" />
