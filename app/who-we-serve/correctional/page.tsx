...
const PATH = "/who-we-serve/correctional";
const TITLE = "Correctional Facility Medical Waste & Controlled Substance Disposal";
const DESC = "Correctional medical waste \u2014 compliant medical waste disposal for correctional facilities, mail-back or pickup, with a Certificate of Destruction. No contract.";
...
const faqs = [
  { q: "How do correctional facilities dispose of medical and controlled waste?", a: "Infirmary sharps and biohazard are handled to OSHA/DOT rules, controlled substances destroyed non-retrievable with DEA Form 41, and everything moves under secure chain-of-custody \u2014 all documented." },
  { q: "How is diversion risk handled in a correctional setting?", a: "Controlled substances are logged, secured, and destroyed non-retrievable with witnessed documentation, minimizing diversion risk under chain-of-custody." },
  { q: "Can you serve a whole correctional system?", a: "Yes \u2014 consistent, documented programs can be standardized across facilities in a system." },
  { q: "Is documentation audit-ready?", a: "Yes \u2014 DEA forms, chain-of-custody, and Certificates of Destruction are archived for audits." },
  { q: "How do you ensure secure chain-of-custody?", a: "Controlled substances are tracked and documented from your infirmary through non-retrievable destruction, with Form 41 and chain-of-custody records — built for diversion-sensitive settings." },
  { q: "Can meds be deactivated on-site for added security?", a: "Yes — on-site deactivation renders controlled substances non-retrievable immediately, inside your facility." },
  { q: "How is infirmary biohazard handled?", a: "Red-bagged and destroyed as regulated medical waste, with documentation." },
...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Service", "@id": `${abs(PATH)}#service`, name: "Correctional facilities \u2014 Medical Waste Disposal", serviceType: "Medical & pharmaceutical waste disposal", description: DESC, provider: { "@id": `${SITE.url}/#organization` }, areaServed: { "@type": "Country", name: "United States" }, audience: { "@type": "Audience", audienceType: "Correctional facilities" }, url: abs(PATH) },
    ...
    <>
      ...
      <main id="main">
        <section className="subhero">
          <div className="wrap">
            <Breadcrumbs items={[{ name: "Who We Serve", href: "/who-we-serve/" }, { name: "Correctional facilities" }]} />
            <span className="eyebrow">Correctional facilities</span>
            <h1 className="ph1" dangerouslySetInnerHTML={{ __html: "Medical Waste Disposal for <span style=\"color:var(--teal)\">correctional facilities.</span>" }} />
            <p className="lead" style={{ marginTop: "18px", maxWidth: "62ch" }} dangerouslySetInnerHTML={{ __html: "Correctional medical waste has an added layer other facilities don\u2019t: security. Infirmary sharps, biohazard, and controlled substances all have to move under strict chain-of-custody. We handle each stream compliantly \u2014 controls destroyed non-retrievable with Form 41, sharps and biohazard to OSHA/DOT rules \u2014 with a Certificate of Destruction." }} />
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What you deal with</span><h2 dangerouslySetInnerHTML={{ __html: "What you actually throw out." }} /><p className="lead" dangerouslySetInnerHTML={{ __html: "From Infirmary sharps & biohazard to Controlled substances (Schedules II\u2013V) \u2014 here\u2019s what correctional facilities generates — and how each stream stays compliant." }} /></div>
            <ul className="covers">
              {["Infirmary sharps & biohazard", "Controlled substances (Schedules II\u2013V)", "Expired & discontinued medications", "Secure chain-of-custody handling", "Medication take-back & destruction"].map((t) => (<li key={t}>{check}<span dangerouslySetInnerHTML={{ __html: t }} /></li>))}
            </ul>
          </div>
        </section>

        <section className="sec wsec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" dangerouslySetInnerHTML={{ __html: `<div class="shead"><span class="eyebrow">Every waste stream, explained</span><h2>Every correctional facility waste stream, explained.</h2><p class="lead">Correctional facilities run infirmaries that generate sharps, red-bag biohazard, controlled substances, and expired medications — all under heightened security and chain-of-custody requirements. Diversion risk makes the paper trail and secure handling non-negotiable. This guide covers every stream and the secure handling correctional settings demand.</p></div><div class="wstreams"><div class="wstream"><h3>Controlled substances</h3><p>Infirmary controlled substances — the stream where secure chain-of-custody matters most.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Expired / unused Schedule II–V infirmary stock</li><li>Wasted &amp; partial doses</li><li>Discontinued controlled orders</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Non-controlled meds (pharmaceutical kit)</li><li>Sharps</li></ul></div></div><p class="ws-meta"><b>The rule</b> — DEA — render non-retrievable, DEA Form 41 for surrendered controls, witnessed logs; on-site deactivation meets non-retrievable guidance.</p><p class="ws-meta"><b>How to dispose</b> — Controlled / medication mail-back kit, or on-site deactivation, to DEA standards.<span class="ws-tip"><b>Tip:</b> On-site deactivation lets you render controls non-retrievable immediately — useful when meds shouldn't leave the building.</span></p></div><div class="wstream"><h3>Sharps</h3><p>Infirmary injection and procedure sharps.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Injection needles &amp; syringes</li><li>Lancets</li><li>Procedure sharps</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Bloody gauze (biohazard)</li><li>Expired meds (pharmaceutical)</li><li>Non-sharp packaging</li></ul></div></div><p class="ws-meta"><b>The rule</b> — OSHA Bloodborne Pathogens Standard — FDA-cleared, puncture-resistant containers, no overfilling, annual training.</p><p class="ws-meta"><b>How to dispose</b> — Sharps mail-back kit.<span class="ws-tip"><b>Tip:</b> Replace containers at the fill line; keep them upright, closable, and out of reach.</span></p></div><div class="wstream"><h3>Biohazard / regulated medical waste</h3><p>Infirmary blood- and fluid-contaminated waste.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Blood-soaked dressings</li><li>Contaminated PPE</li><li>Wound-care biohazard</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Sharps (sharps kit)</li><li>Lightly soiled everyday items</li><li>Expired meds (pharmaceutical)</li></ul></div></div><p class="ws-meta"><b>The rule</b> — OSHA plus your state's medical-waste rules — red bags, labeling, treatment/destruction, retained documentation.</p><p class="ws-meta"><b>How to dispose</b> — Biohazard mail-back kit.<span class="ws-tip"><b>Tip:</b> Only visibly blood/OPIM-contaminated items are red-bag waste — check your state's definition.</span></p></div><div class="wstream"><h3>Pharmaceutical waste</h3><p>Expired non-controlled infirmary medications.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Expired non-controlled meds</li><li>Discontinued medications</li><li>Non-controlled returns</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Controlled substances (own path)</li><li>RCRA-hazardous drugs (own kit)</li><li>Sharps</li></ul></div></div><p class="ws-meta"><b>The rule</b> — Do not drain-dispose; segregate hazardous and controlled drugs; destroy with documentation.</p><p class="ws-meta"><b>How to dispose</b> — Pharmaceutical waste mail-back kit or on-site deactivation.<span class="ws-tip"><b>Tip:</b> Segregate hazardous and controlled drugs first — everything else routes here.</span></p></div></div><p class="wsfoot">One DEA-registered vendor provides secure, documented chain-of-custody destruction for infirmary controls, sharps, and biohazard — with Form 41 and a Certificate of Destruction. No contract. <a href="/resources/correctional-facility-waste-disposal-guide">Get the full guide (free PDF) &rarr;</a></p>` }} />
        </section>
          ...
          <div className="wrap">
            <div className="guideband">
              <div className="gb-body">
                <span className="eyebrow">Free guide · for correctional facilities</span>
                <h3>The Correctional Facility's Guide to Compliant Waste Disposal</h3>
                <p>Infirmary sharps, biohazard & controls — secure, documented destruction. Includes a checklist, cheat sheet & FAQ.</p>
              </div>
              <div className="gb-cta">
                <a className="btn btn-primary" href="/resources/correctional-facility-waste-disposal-guide">Download the free guide <span className="ar">→</span></a>
          ...
          <div className="wrap">
            ...
            <div className="relcols">
              ...
              <div className="relcol"><h3>Guides &amp; articles</h3><ul>
                <li><a href="/resources/correctional-facility-waste-disposal-guide">Free Correctional facilities guide (PDF)</a></li>
        ...
        <section className="sec how" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">FAQ</span><h2>Correctional facilities disposal questions.</h2></div>
      ...
      <ExitIntentGuide slug="correctional-facility-waste-disposal-guide" />
      <MobileCTA primary={{ label: "Get a quote", href: "/get-a-quote?role=Other" }} secondary={{ label: "Build a program", href: "/build-your-program?facility=ltc" }} />
      <Footer />
      <Reveal />
    </>
  );
