...
const PATH = "/who-we-serve/ophthalmology";
const TITLE = "Ophthalmology Waste Disposal | Injection & Surgical Sharps";
const DESC = "Medical waste disposal for ophthalmology clinic \u2014 compliant medical waste disposal for ophthalmology, mail-back or pickup, with a Certificate of Destruction. No contract.";
...
const faqs = [
  { q: "How does an ophthalmology clinic dispose of medical waste?", a: "Sharps and procedure waste ship in OSHA/DOT-compliant containers, expired ophthalmic medications are handled as pharmaceutical waste, and any controlled sedation meds are destroyed non-retrievable \u2014 all with a Certificate of Destruction." },
  { q: "Do you handle intravitreal injection sharps?", a: "Yes \u2014 injection sharps go in OSHA-compliant containers and ship via mail-back or pickup." },
  { q: "Can you take expired eye medications and controlled sedatives?", a: "Yes \u2014 expired medications are handled as pharmaceutical waste, and any controlled substances are destroyed with DEA Form 41 documentation." },
  { q: "Is a contract required?", a: "No \u2014 mail-back has no contract and pickup plans are flexible." },
  { q: "How do we handle the volume of intravitreal injection sharps?", a: "Injection-heavy clinics generate real sharps volume — we size your kits so containers never overfill." },
  { q: "What do we do with expired anti-VEGF or injectable drugs?", a: "As pharmaceutical waste — destroyed with documentation, not flushed." },
  { q: "Is surgical waste handled differently than clinic waste?", a: "Surgical sharps and biohazard follow the same compliant paths; higher volume may favor scheduled pickup — we'll size it." },
...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Service", "@id": `${abs(PATH)}#service`, name: "Ophthalmology \u2014 Medical Waste Disposal", serviceType: "Medical & pharmaceutical waste disposal", description: DESC, provider: { "@id": `${SITE.url}/#organization` }, areaServed: { "@type": "Country", name: "United States" }, audience: { "@type": "Audience", audienceType: "Ophthalmology" }, url: abs(PATH) },
    ...
    <>
      ...
      <main id="main">
        <section className="subhero">
          <div className="wrap">
            <Breadcrumbs items={[{ name: "Who We Serve", href: "/who-we-serve/" }, { name: "Ophthalmology" }]} />
            <span className="eyebrow">Ophthalmology</span>
            <h1 className="ph1" dangerouslySetInnerHTML={{ __html: "Medical Waste Disposal for <span style=\"color:var(--teal)\">ophthalmology.</span>" }} />
            <p className="lead" style={{ marginTop: "18px", maxWidth: "62ch" }} dangerouslySetInnerHTML={{ __html: "Medical waste disposal for an ophthalmology clinic ranges from routine injection sharps to surgical waste from in-office procedures, plus expired ophthalmic medications. We size a mail-back or pickup program to your clinic and keep it OSHA-, DOT-, and DEA-compliant with a Certificate of Destruction every time." }} />
        ...
        <section className="sec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap">
            <div className="shead"><span className="eyebrow">What you deal with</span><h2 dangerouslySetInnerHTML={{ __html: "What you actually throw out." }} /><p className="lead" dangerouslySetInnerHTML={{ __html: "From Intravitreal injection sharps to Surgical & procedure sharps \u2014 here\u2019s what ophthalmology generates — and how each stream stays compliant." }} /></div>
            <ul className="covers">
              {["Intravitreal injection sharps", "Surgical & procedure sharps", "Contaminated PPE & gauze", "Expired ophthalmic medications", "Sedation & controlled meds (where applicable)"].map((t) => (<li key={t}>{check}<span dangerouslySetInnerHTML={{ __html: t }} /></li>))}
            </ul>
          </div>
        </section>

        <section className="sec wsec" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" dangerouslySetInnerHTML={{ __html: `<div class="shead"><span class="eyebrow">Every waste stream, explained</span><h2>Every ophthalmology practice waste stream, explained.</h2><p class="lead">Ophthalmology combines clinic and surgical care — cataract and other procedures, and intravitreal injections that run at real volume — so you generate surgical and injection sharps, expired injectable drugs, and biohazard well beyond an optometry office. This guide covers every stream.</p></div><div class="wstreams"><div class="wstream"><h3>Sharps</h3><p>Intravitreal injection and surgical sharps.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Intravitreal injection needles</li><li>Surgical blades &amp; needles</li><li>Syringes &amp; cannulas</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Bloody gauze (biohazard)</li><li>Expired meds (pharmaceutical)</li><li>Non-sharp packaging</li></ul></div></div><p class="ws-meta"><b>The rule</b> — OSHA Bloodborne Pathogens Standard — FDA-cleared, puncture-resistant containers, no overfilling, annual training.</p><p class="ws-meta"><b>How to dispose</b> — Sharps mail-back kit.<span class="ws-tip"><b>Tip:</b> Replace containers at the fill line; keep them upright, closable, and out of reach.</span></p></div><div class="wstream"><h3>Pharmaceutical waste</h3><p>Expired injectable drugs and anesthetics.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Expired anti-VEGF &amp; injectables</li><li>Topical &amp; injectable anesthetics</li><li>Other expired non-controlled meds</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Controlled substances (own kit)</li><li>RCRA-hazardous drugs (own kit)</li><li>Sharps</li></ul></div></div><p class="ws-meta"><b>The rule</b> — Do not drain-dispose; segregate hazardous and controlled drugs; destroy with documentation.</p><p class="ws-meta"><b>How to dispose</b> — Pharmaceutical waste mail-back kit.<span class="ws-tip"><b>Tip:</b> Segregate hazardous and controlled drugs first — everything else routes here.</span></p></div><div class="wstream"><h3>Biohazard / regulated medical waste</h3><p>Surgical and procedure regulated waste.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Surgical &amp; procedure biohazard</li><li>Blood-soaked materials</li><li>Contaminated PPE</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Sharps (sharps kit)</li><li>Lightly soiled everyday items</li><li>Expired meds (pharmaceutical)</li></ul></div></div><p class="ws-meta"><b>The rule</b> — OSHA plus your state's medical-waste rules — red bags, labeling, treatment/destruction, retained documentation.</p><p class="ws-meta"><b>How to dispose</b> — Biohazard mail-back kit.<span class="ws-tip"><b>Tip:</b> Only visibly blood/OPIM-contaminated items are red-bag waste — check your state's definition.</span></p></div><div class="wstream"><h3>Controlled substances</h3><p>If you use sedation for procedures.</p><div class="ws-io"><div class="ws-col in"><span class="ws-lbl">Goes in</span><ul><li>Expired / unused Schedule I–V sedatives</li><li>Wasted &amp; partial doses</li><li>Surrendered controlled stock</li></ul></div><div class="ws-col out"><span class="ws-lbl">Keep out</span><ul><li>Non-controlled meds (pharmaceutical kit)</li><li>Sharps</li></ul></div></div><p class="ws-meta"><b>The rule</b> — DEA — render non-retrievable, DEA Form 41 for surrendered controls, witnessed logs.</p><p class="ws-meta"><b>How to dispose</b> — Controlled / medication mail-back kit, to DEA standards.<span class="ws-tip"><b>Tip:</b> Log and witness every wasted controlled dose — the DEA checks the paper trail.</span></p></div></div><p class="wsfoot">One vendor can take your injection and surgical sharps, expired injectables, and biohazard — by prepaid mail-back kit or scheduled pickup — with a Certificate of Destruction and no contract. <a href="/resources/ophthalmology-waste-disposal-guide">Get the full guide (free PDF) &rarr;</a></p>` }} />
        </section>
          ...
          <div className="wrap">
            <div className="guideband">
              <div className="gb-body">
                <span className="eyebrow">Free guide · for ophthalmology</span>
                <h3>The Ophthalmology Practice's Guide to Compliant Waste Disposal</h3>
                <p>Intravitreal injections, surgical sharps & expired drugs — every stream, handled right. Includes a checklist, cheat sheet & FAQ.</p>
              </div>
              <div className="gb-cta">
                <a className="btn btn-primary" href="/resources/ophthalmology-waste-disposal-guide">Download the free guide <span className="ar">→</span></a>
          ...
          <div className="wrap">
            ...
            <div className="relcols">
              ...
              <div className="relcol"><h3>Guides &amp; articles</h3><ul>
                <li><a href="/resources/ophthalmology-waste-disposal-guide">Free Ophthalmology guide (PDF)</a></li>
        ...
        <section className="sec how" style={{ paddingTop: "clamp(48px,6vw,80px)" }}>
          <div className="wrap" style={{ maxWidth: "820px" }}>
            <div className="shead"><span className="eyebrow">FAQ</span><h2>Ophthalmology disposal questions.</h2></div>
      ...
      <ExitIntentGuide slug="ophthalmology-waste-disposal-guide" />
