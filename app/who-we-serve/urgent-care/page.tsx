...
const faqs = [
  ...
  { q: "How do we handle controlled pain meds?", a: "Expired or wasted Schedule II–V drugs are destroyed non-retrievable with a DEA Form 41 and witnessed waste logs." },
