...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Article", "@id": `${abs(PATH)}#article`, headline: "The NIOSH Hazardous Drug List, Explained (USP 800)", description: DESC, author: { "@type": "Person", name: "Easy Rx Cycle Team" }, publisher: { "@id": `${SITE.url}/#organization` }, datePublished: "2026-07-20", dateModified: "2026-07-31", mainEntityOfPage: abs(PATH), image: abs(SITE.ogImage) },
