...
const PATH = "/blog/how-to-dispose-of-controlled-drugs-for-surgery-center";
const TITLE = "How to Dispose of Controlled Drugs for Surgery Centers (DEA Guide)";
const DESC = "A DEA-compliant guide to disposing of controlled drugs for surgery centers: the schedules you handle, your disposal options, the forms you need, and the mistakes that fail audits.";
...
const faqs = [
  { q: "How do surgery centers dispose of wasted anesthesia drugs?", a: "Partial vials and wasted controlled substances are logged, witnessed, and routed to a DEA-registered reverse distributor for non-retrievable destruction \u2014 never flushed or trashed." },
  { q: "Do ASCs need DEA Form 222?", a: "Yes, for transferring Schedule II drugs like fentanyl and morphine to a reverse distributor. Form 41 documents the destruction." },
  { q: "What's the best disposal option for a small surgery center?", a: "A DEA-registered reverse distributor with scheduled pickup or mail-back kits \u2014 compliant, documented, and low-overhead for limited staff." },
  { q: "How long do we keep disposal records?", a: "At least two years \u2014 DEA Forms 222 and 41, Certificates of Destruction, and controlled-drug logs." },
  { q: "Can we destroy controlled substances on-site?", a: "It's legal but high-risk: you must render them irretrievable, complete Form 41, and capture two witness signatures. Most ASCs outsource to avoid audit findings." }
];

const jsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    { "@type": "Article", "@id": `${abs(PATH)}#article`, headline: "How to Dispose of Controlled Drugs for Surgery Centers", description: DESC, author: { "@type": "Person", name: "William Doxey" }, publisher: { "@id": `${SITE.url}/#organization` }, datePublished: "2025-09-21", dateModified: "2026-07-31", mainEntityOfPage: abs(PATH), image: abs(SITE.ogImage) },
        ...
        <section className="sec" style={{ paddingTop: "clamp(30px,4vw,52px)", paddingBottom: "0" }}>
          <div className="blogwrap">
            <article className="article">
              <Breadcrumbs items={[{ name: "Blog", href: "/blog" }, { name: "Controlled Drugs for Surgery Centers" }]} />
              <span className="eyebrow">Controlled Substances</span>
              <h1 className="ph1" dangerouslySetInnerHTML={{ __html: "How to Dispose of Controlled Drugs for Surgery Centers" }} />
              ...
              <p className="article-lead" dangerouslySetInnerHTML={{ __html: "Ambulatory surgery centers run on controlled substances &mdash; anesthesia and pain medications, much of it Schedule II. With limited staff wearing many hats, compliant disposal has to be simple and airtight. Here&rsquo;s how to do it right." }} />

              <div className="prose">
            <div className="tocbox">
              <h4>In this guide</h4>
              <ol>
                <li><a href="#what" dangerouslySetInnerHTML={{ __html: "Which controlled drugs surgery centers handle" }} /></li>
            ...
            <h2 id="what" dangerouslySetInnerHTML={{ __html: "What controlled drugs does surgery centers handle?" }} />
            <p dangerouslySetInnerHTML={{ __html: "The DEA schedules the controlled substances surgery centers commonly stock:" }} />
            <ul><li dangerouslySetInnerHTML={{ __html: "<strong>Schedule II:</strong> Fentanyl, morphine, hydromorphone, remifentanil" }} /><li dangerouslySetInnerHTML={{ __html: "<strong>Schedule III:</strong> Ketamine, buprenorphine" }} /><li dangerouslySetInnerHTML={{ __html: "<strong>Schedule IV&ndash;V:</strong> Midazolam, diazepam, lorazepam" }} /></ul>
            ...
            <h2 id="checklist" dangerouslySetInnerHTML={{ __html: "Controlled-drug disposal checklist for surgery centers" }} />
            <ol><li dangerouslySetInnerHTML={{ __html: "Maintain an accurate controlled-substance log" }} /><li dangerouslySetInnerHTML={{ __html: "Review inventory regularly for expired stock" }} /><li dangerouslySetInnerHTML={{ __html: "Segregate expired controls securely" }} /><li dangerouslySetInnerHTML={{ __html: "Use a DEA-registered reverse distributor" }} /><li dangerouslySetInnerHTML={{ __html: "Complete DEA Forms 222 and 41" }} /><li dangerouslySetInnerHTML={{ __html: "Retain records and CODs for two years" }} /><li dangerouslySetInnerHTML={{ __html: "Schedule disposal every 30 to 90 days based on volume" }} /></ol>
                ...
                <div className="postcta">
                  <h3>Get a DEA-compliant quote for surgery centers.</h3>
                ...
                <RelatedPosts slug="how-to-dispose-of-controlled-drugs-for-surgery-center" />
              </div>
            </article>
          </div>
        </section>
