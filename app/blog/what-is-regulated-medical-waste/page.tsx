...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Article", "@id": `${abs(PATH)}#article`, headline: "What Is Regulated Medical Waste (RMW)? A Simple Guide", description: DESC, author: { "@type": "Person", name: "Easy Rx Cycle Team" }, publisher: { "@id": `${SITE.url}/#organization` }, datePublished: "2026-07-20", dateModified: "2026-07-31", mainEntityOfPage: abs(PATH), image: abs(SITE.ogImage) },
